...
export const WindowsModal = ({onClose}) => {
    ...
    return (
        <div className={`h-96 w-96 bg-white border-2 border-l-gray border-t-gray absolute top-32 left-20 border-r-darkGray border-b-darkGray flex flex-col ${modalVisibility}`}>
